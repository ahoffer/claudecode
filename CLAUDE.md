...
NEVER MENTION CLAUDE, CHATGPT, COPILOT, OR ANY OTHER AI TOOL IN A GIT COMMIT MESSAGE. ACTIVELY SCAN COMMIT TITLES, BODIES, TRAILERS, CO-AUTHOR LINES, GENERATED COMMENTS, AND ANY OTHER COMMIT TEXT TO ENSURE NO AI ATTRIBUTION APPEARS. IT IS STRICTLY FORBIDDEN FOR A COMMIT TO CONTAIN ANY INDICATION THAT AN AI OR CODING ASSISTANT WAS INVOLVED.
